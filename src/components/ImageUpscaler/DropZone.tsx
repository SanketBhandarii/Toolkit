...
export default function DropZone({ onSelect }: { onSelect: (file: File) => void }) {
  ...
  return (
    ...
    >
      ...
      <p className="text-gray-400 text-sm"><span className="font-semibold">Click to upload</span> or drag and drop</p>
